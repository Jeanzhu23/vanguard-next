...
// ─────────────────────────────────────────────────────────────
// PASTE THIS INTO lib/site.js
// (anywhere alongside your other exports, e.g. near membership tiers)
// ─────────────────────────────────────────────────────────────

export const juniorEnrollment = {
  eyebrow: "Back-to-School Enrollment · Now Open",
  headline: "New school year. New golf season. Same weekly routine.",
  blurb:
    "Fall schedules fill fast. Lock in your junior's weekly lesson and training times before the semester starts — indoors, all year, so homework season never interrupts development. Every athlete is placed by a coach-led evaluation.",
};

export const juniorPrograms = [
  {
    id: "foundations",
    pathway: "The Junior Pathway · Entry Level",
    name: "Vanguard Foundations",
    priceLabel: "Starting from",
    price: "$700",
    per: "/ month",
    condition: "Base package — weekly private lessons",
    featured: false,
    features: [
      "Weekly private lessons with a teaching professional",
      "TrackMan feedback on every swing",
      "Add group gym (TPI strength, mobility & movement)",
      "Add group short game — chipping & putting",
    ],
    cta: { label: "Request an evaluation →", href: "/junior-golf/evaluation" },
  },
  {
    id: "rising-players",
    pathway: "The Junior Pathway · Advanced",
    name: "Vanguard Rising Players",
    priceLabel: "Starting from",
    price: "$1,100",
    per: "/ month",
    condition: "Member rate",
    featured: false,
    features: [
      "Private lessons with our senior-level teaching professionals",
      "Scoring awareness, course strategy & competition prep",
      "Group gym — TPI strength, mobility & movement",
      "Group short game — chipping & putting",
    ],
    cta: { label: "Request an evaluation →", href: "/junior-golf/evaluation" },
  },
];
...
export const juniorMembershipPerks = [
  "24/7 club access",
  "8 complimentary TrackMan sessions every month",
  "Unlimited chipping & putting",
  "Unlimited gym",
];

export const juniorProgramsFootnote =
  "Final program placement and package pricing are confirmed after your golfer's evaluation. Packages are built from your combination of lessons, gym, and short game sessions.";